...
fn main() -> std::io::Result<()> {
    ...
    simulator.run_command_in_powershell(format!("Start-Process -FilePath ${{{DRIVER_LETTER_VAR_NAME}}}\\write.exe -ArgumentList ${{{DRIVER_LETTER_VAR_NAME}}} -WindowStyle Hidden").as_str())?;
